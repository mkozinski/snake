...
class Loss_MSE_GaussSnake_noGrad(nn.Module):
    def __init__(self, stepsz,alpha,beta,fltrstdev,ndims,nsteps,
        ...
        self.fltrt=th.from_numpy(self.fltr)

        self.iscuda=False

    def cuda(self):
        super(Loss_MSE_GaussSnake_noGrad,self).cuda()
    ...
    def forward(self,pred_dmap,lbl_graphs):
        ...
        for l,g in zip(lbl_graphs,gimg):
